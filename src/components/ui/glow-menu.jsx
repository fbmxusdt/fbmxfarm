...
// Radial rainbow glow — always dark since the game is dark-only
const NAV_GLOW_BG =
  ...
  ({ className, items, activeItem, onItemClick, ...props }, ref) => {
    return (
      <motion.nav
        ...
        {...props}
      >
        {/* Rainbow radial glow that appears on nav hover */}
        <motion.div
          className="absolute -inset-2 rounded-3xl z-0 pointer-events-none"
          variants={navGlowVariants}
          style={{ background: NAV_GLOW_BG }}
        />
